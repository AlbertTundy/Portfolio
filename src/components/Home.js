        ...
        <div className="col-sm-12">
            <div className="row">
                <p className="wraptext col-sm-12">
                    <img className="aboutMePic" src="./Camera Roll/WIN_20210112_21_10_11_Pro.jpg" alt="laptop selfi"/>
